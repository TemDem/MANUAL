...
const quickSlider = new Swiper('.quick-slider', {
	navigation: {
		nextEl: '.quick-slider__arrows-next',
		prevEl: '.quick-slider__arrows-prev',
	},
	speed: 1000,
	slidesPerView: 2.01,
	watchOverflow: true,
...
const quickSliderArrow = document.querySelectorAll(".quick-slider-arrow");
quickSliderArrow[0].classList.add('_disabled')
quickSliderArrow[quickSliderArrow.length - 1].classList.add("_disabled");


const meetSlider = new Swiper(".meet-slider__slider", {
	speed: 1000,
	slidesPerView: 3,
	watchOverflow: true,
	spaceBetween: 40,
	pagination: {
		el: '.meet-slider__pahination',
		clickable:true,
	},
	autoplay: {
    delay: 6000,
...
const guidedSlider = new Swiper(".guided-slider__slider", {
	speed: 1000,
	slidesPerView: 4.5,
	watchOverflow: true,
	spaceBetween: 10,
...
const iconMenu = document.querySelector(".header-row__burger");
if (iconMenu) {
  const menuBody = document.querySelector(".menu-left");
...
function scrollHeader(header, firstSection) {
	if (header, firstSection) {
		document.addEventListener('scroll', e => {
			let windowScrolltop = window.pageYOffset
			if (windowScrolltop > 0) {
				header.classList.add('_scroll')
				firstSection.classList.add("_scroll-section");
			} else {
				header.classList.remove("_scroll");
				firstSection.classList.remove("_scroll-section");
			}
		})
	}
}

scrollHeader(header, firstSection);
